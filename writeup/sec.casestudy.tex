...
The domain expert defines which analysis should be performed and how the results should be visualized. The application programmer implements the transformations in e.g. SQL or MapReduce.
