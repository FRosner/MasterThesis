...
A typical way to model text data is to model documents as a list of independent tokens (\cite{murphy2012machine},~p.~87-89). It has been found that modeling the word counts per document using a multinomial distribution yields good results (\cite{mccallum1998comparison}).
