...
DGMs are natural for modeling flat data, i.e. single variables and their relation. When it comes to hierarchical data, traditional DGMs become verbose very quickly. Consider a set of $s$ students, all writing the same exam. This would require to add $s$ vertices to the DGM to capture this repeated measurement.
