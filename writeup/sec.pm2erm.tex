...
\begin{itemize}
\item variables $\Rightarrow$ attributes
\item Variables that are not inside of a plate need to be assigned to an artificial entity type called 'Global' (\cite{heckerman2007probabilistic})
