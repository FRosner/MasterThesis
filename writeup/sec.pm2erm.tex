...
\begin{figure}
\centering
\resizebox{.9\linewidth}{!}{\input{img/apm_vectors.tex}}
\caption{Converting plate models to atomic plate models. Vector variables will be repeated for each component and arrows are left out.}\label{fig:pm2apm}
\end{figure}
