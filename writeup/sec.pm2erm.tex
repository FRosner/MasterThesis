...
\begin{figure}
\centering
\scalebox{.9}{\adjustTikzSize \input{img/apm_vectors.tex}}
...
\begin{figure}
\centering
\scalebox{.9}{\adjustTikzSize \input{img/pm2erm_uno_local.tex}}
...
\begin{figure}
\centering
\scalebox{.9}{\adjustTikzSize \input{img/pm2erm_uno_global.tex}}
...
\begin{figure}
\centering
\scalebox{.9}{\adjustTikzSize \input{img/pm2erm_bi_noconstraints.tex}}
\caption{Conversion of a plate intersection to an association entity.}\label{fig:pm2erm_bi_noconstraints}
\end{figure}

\begin{figure}
\centering
\scalebox{.9}{\adjustTikzSize \input{img/pm2erm_bi_constraints.tex}}
